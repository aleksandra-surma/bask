  ...
  return (
    <section className="w-full max-w-screen-xl py-20 px-4 tablet:px-8">
      ...
      <div className="m-auto justify-between items-center min-h-[60vh] flex flex-wrap">
        <div className="flex flex-col justify-between w-[48%] laptop:w-[20%] h-[450px] mb-24 laptop:mb-0 cursor-pointer">
          <div className="relative h-[360px] rounded rounded-[8px] overflow-hidden">
            <Image src={best1} layout="fill" objectFit="cover" quality={70} className="transition-transform hover:scale-105 duration-300" alt="" />
          </div>
        ...
        <div className="flex flex-col justify-between w-[48%] laptop:w-[20%] h-[450px] mb-24 laptop:mb-0 cursor-pointer">
          <div className="relative h-[360px] rounded rounded-[8px] overflow-hidden">
            <Image src={best2} layout="fill" objectFit="cover" quality={70} className="transition-transform hover:scale-105 duration-300" alt="" />
          </div>
        ...
        <div className="flex flex-col justify-between w-[48%] laptop:w-[20%] h-[450px] mb-24 laptop:mb-0 cursor-pointer">
          <div className="relative h-[360px] rounded rounded-[8px] overflow-hidden">
            <Image src={best3} layout="fill" objectFit="cover" quality={70} className="transition-transform hover:scale-105 duration-300" alt="" />
          </div>
        ...
        <div className="flex flex-col justify-between w-[48%] laptop:w-[20%] h-[450px] mb-24 laptop:mb-0 cursor-pointer">
          <div className="relative h-[360px] rounded rounded-[8px] overflow-hidden">
            <Image src={best4} layout="fill" objectFit="cover" quality={70} className="transition-transform hover:scale-105 duration-300" alt="" />
          </div>
